						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-3">
								<div class="form-group">
									...
									<span class="block input-icon input-icon-right">
										<input onblur="get_bull(this.value)" type="text" class="width-100" id="bull_number" name="bull_number" value="{{old('bull_number',$cattle->bull_number)}}">
									</span>
								</div>
							</div>
							<div class="col-xs-12 col-sm-3">
								<div class="form-group">
									...
									<span class="block input-icon input-icon-right">
										<input type="text" class="width-100" name="bull_name" id="bull_name" value="{{old('bull_name',$cattle->bull_name)}}">
									</span>
								</div>
							</div>
							<div class="col-xs-12 col-sm-3">
