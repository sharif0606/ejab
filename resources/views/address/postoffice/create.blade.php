    ...
    <div class="col-xs-12">
        ...
        <div class="widget-box">
			<div class="widget-header widget-header-small">
				<h5 class="widget-title lighter">Post Office Add Form</h5>
			</div>
			<div class="widget-body">
				<div class="widget-main">
					<form action="{{route(currentUser().'.postoffice.store')}}" method="post" class="form-search">
					@csrf
						<div class="row">
