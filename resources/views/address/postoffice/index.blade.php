...
<div class="row">
    ...
    <a class="btn btn-primary pull-right" href="{{route(currentUser().'.postoffice.create')}}">Add New</a>
        <!-- PAGE CONTENT BEGINS -->
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                @if($postoffice)
                    @foreach($postoffice as $i=>$u)
                        <tr>
                            <td>{{++$i}}</td>
                            <td>{{$u->upazilla->upazilla}}</td>
                            <td>{{$u->postoffice}}</td>
                            <td>
                                <a href="{{route(currentUser().'.postoffice.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
                            </td>
                        </tr>
                    @endforeach
                @endif
