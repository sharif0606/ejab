...
<div class="row">
    ...
    <a class="btn btn-primary pull-right" href="{{route(currentUser().'.village.create')}}">Add New</a>
        <!-- PAGE CONTENT BEGINS -->
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                @if($village)
                    @foreach($village as $i=>$u)
                        <tr>
                            <td>{{++$i}}</td>
                            <td>{{$u->thana->thana}}</td>
                            <td>{{$u->village}}</td>
                            <td>
                                <a href="{{route(currentUser().'.village.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
                            </td>
                        </tr>
                    @endforeach
                @endif
