...
<div class="row">
    ...
    <a class="btn btn-primary pull-right" href="{{route(currentUser().'.thana.create')}}">Add New</a>
        <!-- PAGE CONTENT BEGINS -->
        <table class="table">
            <thead>
                <tr>
            ...
            <tbody>
                @if($thana)
                    @foreach($thana as $i=>$u)
                        <tr>
                            <td>{{++$i}}</td>
                            <td>{{$u->upazilla->upazilla}}</td>
                            <td>{{$u->thana}}</td>
                            <td>
                                <a href="{{route(currentUser().'.thana.edit',$u->id)}}" ><i class="fa fa-edit"></i></a>
                            </td>
                        </tr>
                    @endforeach
                @endif
